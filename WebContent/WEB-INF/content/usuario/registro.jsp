...
<form action="<s:url action="registro" namespace="/usuario" />" class="form-horizontal" method="post">
...
<div class="controls">
<input id="password_conf" type="password" name="passwordConfirmation" value=""/>
</div>
